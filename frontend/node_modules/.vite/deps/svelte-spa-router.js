...
function Router($$anchor, $$props) {
  if (new.target) return createClassComponent({ component: Router, ...$$anchor });
  push($$props, false, Router);
  let routes = prop($$props, "routes", 28, () => ({}));
  let prefix = prop($$props, "prefix", 12, "");
  let restoreScrollState = prop($$props, "restoreScrollState", 12, false);
  class RouteItem {
    /**
