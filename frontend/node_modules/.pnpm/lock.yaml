...
devDependencies:
  ...
  svelte-preprocess:
    specifier: ^6.0.3
    version: 6.0.3(sass@1.83.0)(svelte@4.2.19)
  vite:
    specifier: ^4.5.5
    version: 4.5.5(sass@1.83.0)
...
packages:
  ...
  /node-sprite@0.1.1:
    ...
    dependencies:
      coffee-script: 1.3.3
      imagemagick: '@github.com/naltatis/node-imagemagick/tarball/master'
      seq: 0.3.5
      underscore: 1.3.1
      watch: 0.5.1
    dev: false
  ...
  /svelte-preprocess@6.0.3(sass@1.83.0)(svelte@4.2.19):
  ...
  /svelte-router@1.8.1:
    resolution: {integrity: sha512-6mlvZn5RUqTC1PNkIhkJsuaIeZt8wzA4sqdJcbMTzpeI+cnlkhhAFeFl+6sD9eimMxELQ1dihM+1vEtRpQkHLw==}
    dependencies:
      history: 4.10.1
    dev: false
  ...
  '@github.com/naltatis/node-imagemagick/tarball/master':
    resolution: {tarball: http://github.com/naltatis/node-imagemagick/tarball/master}
    name: imagemagick
    version: 0.1.2
    dev: false
